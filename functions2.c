...
/**
 * print_non_printable - This is a function that prints ASCII codes
...
/**
 * print_reverse - This is a function that prints a reversed string.
 * @types: This is a list of arguments passed to the function
 * @buffer: This is an array to handle print
 * @flags:  Computes active flags
 * @width: Specifies the width
...
/**
 * print_rot13string - This is a function that prints a string in rot13.
 * @types: This is a list of arguments passed to the function
 * @buffer: This is an array to handle print
 * @flags:  Computes active flags
 * @width: Specifies the width
